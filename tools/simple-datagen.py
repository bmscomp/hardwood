...
# ============================================================================
# Exercises the native PLAIN and BYTE_STREAM_SPLIT decode paths in the
# Java 22 multi-release PageDecoder (NativePlainDecoder / NativeBssDecoder).
# Uses Parquet V2 pages + GZIP compression so the FFM routing path is
# activated (the java21 fallback uses the heap-copy path instead).
